  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-black text-white p-6 flex flex-col items-center justify-center">
      ...
      >
        ...
        >
          Veteran-owned and AI-powered development studio specializing in custom web solutions,
          business process automation, and intelligent tools built with React, Node.js, Firebase,
          and OpenAI.
        </motion.p>
        ...
        >
          ...
          <motion.div 
            ...
            className="w-full sm:w-auto"
          >
            <Button variant="ghost" asChild className="text-base md:text-lg px-8 py-4 w-full sm:w-auto text-gray-300 hover:bg-gray-800 hover:text-white shadow-lg">
              <a 
                href="/resume.pdf" 
                target="_blank" 
        ...
        >
          <p className="text-gray-300">
            Based in Lexington, KY • Proudly Veteran-Owned • Built with Passion & Precision
          </p>
        </motion.div>
        ...
        >
          <motion.img
            src="https://storage.googleapis.com/boswellwebdevsolutionsllc/full-stack-web-developer-nanodegree.png"
