...
import { FaLinkedin, FaGithub, FaEnvelope, FaCertificate, FaRocket, FaShieldAlt, FaFlag, FaCode, FaClock } from 'react-icons/fa';
      ...
      <div className='min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-black text-white overflow-hidden relative'>
        ...
        <div className='pt-24 pb-16 px-6 flex flex-col items-center justify-center min-h-screen relative'>
          ...
          >
            ...
            {/* Heading */}
            <motion.h1 variants={itemVariants} className='text-4xl md:text-6xl lg:text-7xl font-bold mb-8 tracking-wide'>
              <span className='bg-gradient-to-r from-blue-400 via-white to-blue-400 bg-clip-text text-transparent'>
                Boswell Web Development
              </span>
              <br />
              <span className='text-3xl md:text-4xl lg:text-5xl text-gray-300 font-light'>Solutions LLC</span>
            </motion.h1>
            ...
            <motion.div variants={itemVariants} className='mb-16'>
              <div className='flex flex-wrap justify-center gap-4 text-sm md:text-base text-gray-400'>
                <span className='px-4 py-2 bg-gray-800/50 rounded-full border border-gray-700'>React</span>
                <span className='px-4 py-2 bg-gray-800/50 rounded-full border border-gray-700'>Node.js</span>
                <span className='px-4 py-2 bg-gray-800/50 rounded-full border border-gray-700'>Firebase</span>
                <span className='px-4 py-2 bg-gray-800/50 rounded-full border border-gray-700'>OpenAI</span>
                <span className='px-4 py-2 bg-gray-800/50 rounded-full border border-gray-700'>TypeScript</span>
              </div>
            </motion.div>
            ...
            {/* Cert line */}
            <motion.div variants={itemVariants} className='flex justify-center items-center gap-3 text-gray-400'>
              <FaCertificate className='text-yellow-400 text-lg' />
              <span className='text-sm md:text-base'>Veteran-Owned Business • Lexington, Kentucky</span>
            </motion.div>
          </motion.div>
        </div>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
              <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }}>
                ...
                <p className='text-gray-300 leading-relaxed mb-6 text-lg'>
                  Founded by Charles Boswell, a U.S. Navy veteran with over 20 years of government service, including 16 years managing wildfire operations.
                  We bring military-grade precision, reliability, and problem-solving expertise to every project.
                </p>
                <p className='text-gray-300 leading-relaxed text-lg'>
                  Every solution is crafted with the same attention to detail and commitment to excellence that defined our military service.
                </p>
              </motion.div>
              ...
              >
                <div className='bg-gray-800/50 rounded-lg p-6 border border-gray-700 hover:border-blue-500/50 transition-colors'>
                  <div className='flex items-center gap-3 mb-3'>
                    ...
                    <span className='text-white font-semibold'>Custom Development</span>
                  </div>
                  <p className='text-gray-300 text-sm'>No templates. Every line of code is purpose-built.</p>
                </div>
                ...
                <div className='bg-gray-800/50 rounded-lg p-6 border border-gray-700 hover:border-green-500/50 transition-colors'>
                  ...
                  <p className='text-gray-300 text-sm'>Cutting-edge AI features for competitive advantage.</p>
                </div>
                ...
                <div className='bg-gray-800/50 rounded-lg p-6 border border-gray-700 hover:border-red-500/50 transition-colors'>
                  <div className='flex items-center gap-3 mb-3'>
                    ...
                    <span className='text-white font-semibold'>Veteran Standards</span>
                  </div>
                  <p className='text-gray-300 text-sm'>Military-grade security and reliability.</p>
                </div>
              </motion.div>
            </div>
          </div>
        ...
        >
          <div className='max-w-6xl mx-auto text-center'>
            <motion.h2 className='text-3xl md:text-4xl font-bold text-white mb-16'>What Sets Us Apart</motion.h2>
              ...
              {[
                {
                  ...
                  description: 'Built from scratch using modern frameworks. No WordPress templates or cookie-cutter approaches.',
                },
                {
                  icon: FaRocket,
                  title: 'AI-Powered',
                  description: 'Intelligent automation, chatbots, and AI features that give your business a competitive edge.',
                },
                {
                  icon: FaShieldAlt,
                  title: 'Battle-Tested',
                  description: 'Veteran-owned reliability with military precision in security, performance, and delivery.',
                },
              ].map((service, index) => (
                <motion.div
                  key={index}
        ...
        >
          <div className='max-w-4xl mx-auto text-center'>
            <motion.h2 className='text-3xl md:text-4xl font-bold text-white mb-8'>Ready to Start Your Project?</motion.h2>
            <motion.p className='text-lg text-gray-300 mb-12 max-w-2xl mx-auto'>
              Let&apos;s discuss your vision and create something extraordinary together. Every project begins with understanding your unique needs.
            </motion.p>
